...
from icecube import dataclasses, simclasses, recclasses, spline_reco
from I3Tray import *
import sys
...
#                    print inst
    ...
    tray.AddModule("I3Reader", "source",
                   FilenameList=files)
    tray.AddModule(print_short, 'print', Streams=[icetray.I3Frame.Physics])
    #tray.AddSegment(cascade_l5_cuts_data, 'cascade_l5_cuts_data')
    tray.AddModule(reco_q.calc_hitDOMs, 'hitDOMs',
                   Streams=[icetray.I3Frame.Physics])
    tray.AddModule(cuts, 'cuts',
                   Streams=[icetray.I3Frame.Physics])
    tray.AddModule(add_weighted_primary, 'primary',
                   Streams=[icetray.I3Frame.Physics])
    if do_classification:
        tray.AddModule(DeepLearningClassifier, 'dl_class')

    # if muongun calculate some truth variables

...
inputs["Branch1"] = {"variables": ["charge", "time", 'time_spread', 'first_charge', "av_charge_width", 'av_time_charges', 'num_pulses', "time_moment_2"],
                     "transformations": [tr.centralize, tr.centralize, tr.centralize, tr.centralize, tr.centralize, tr.centralize, tr.identity, tr.identity]}
...
def model(input_shapes, output_shapes):
    ...
    input_b1 = Input(shape=input_shapes["Branch1"]["general"],
                     name = "Input-Branch1")
    z1 = Conv3D(24, (3, 3, 5), padding="same", **kwargs)(input_b1)
    z1 = MaxPooling3D(pool_size=(2, 2, 3))(z1)
    z1 = Conv3D(32, (2, 2, 4))(z1)
    z1 = Dropout(rate=0.2)(z1)
    z1 = BatchNormalization()(z1)
    z1 = Conv3D(48, (2, 2, 3))(z1)

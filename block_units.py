...
def inception_unit(nfilters, x0, strides = (1, 1, 1)):
    ...
    x1 = Convolution3D(nfilters, (3, 3, 3), strides=strides,  padding='same', activation='relu')(x1)

    x2 = Convolution3D(nfilters, (1, 1, 1), padding='same', activation='relu')(x0)
    x2 = Convolution3D(nfilters, (5, 5, 5), strides=strides, padding='same', activation='relu')(x2)

    x3 = Convolution3D(nfilters, (1, 1, 1), padding='same', activation='relu')(x0)
    x3 = Convolution3D(nfilters, (7, 7, 7), strides=strides, padding='same', activation='relu')(x0)
